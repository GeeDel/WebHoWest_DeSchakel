...
{
    public partial class DbandSeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-0000-0000-0000-000000000001", "eb02d950-c415-4978-958a-96aec64827ea", "Admin", "ADMIN" },
                    { "00000000-0000-0000-0000-000000000002", "606b2b19-23db-4f1f-9b33-a5238ece4b5d", "Programmator", "PROGRAMMATOR" },
                    { "00000000-0000-0000-0000-000000000003", "0970227e-32b6-463f-845a-257ca1185eea", "Onthaal", "ONTHAAL" },
                    { "00000000-0000-0000-0000-000000000004", "0e9694f7-09a2-432d-9149-7d4c45d7da0a", "Bezoeker", "BEZOEKER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-0000-0000-0000-000000000001", 0, "Beveren-Leie", "c8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@cc.be", true, "Geert", "Deloof", false, null, "ADMIN@CC.BE", "ADMIN@CC.BE", "AQAAAAEAACcQAAAAEFCDOAv3U5WbM6ZvRBK1cz49qopm95WcuxusZ/yFZK836WaYCf69tYUbCy0g8dm5WQ==", null, false, "VVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "admin@cc.be", "8791" },
                    { "00000000-0000-0000-0000-000000000002", 0, "Gent", "d8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "maaike@cc.be", true, "Maaike", "Tubex", false, null, "MAAIKE@CC.BE", "MAAIKE@CC.BE", "AQAAAAEAACcQAAAAEM8oK78XkAU9oFEz3kTJiSxb6LHNIfhOVyYMkRsYkqzVEx5gLxovIIEAt0ioJlZdQA==", null, false, "XVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "maaike@cc.be", "9000" },
                    { "00000000-0000-0000-0000-000000000003", 0, "Waregem", "e8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "joost@cc.be", true, "Joost", "Van den Kerkhove", false, null, "JOOST@CC.BE", "JOOST@CC.BE", "AQAAAAEAACcQAAAAEGvzeCJJlfvnHsPJeG7EYzzMF/dk/L66vqO/RpN3ckSZt9m7cB0oyna3bpfnqvmZLA==", null, false, "ZVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "joost@cc.be", "8790" },
                    { "00000000-0000-0000-0000-000000000004", 0, "Harelbeke", "e8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "veerle@cc.be", true, "Veerle", "Hollants", false, null, "VEERLE@CC.BE", "VEERLE@CC.BE", "AQAAAAEAACcQAAAAENUy5d0qA60I4uwsakInYPVchN31UaWov7GfKWNxLZpj9VpsvlEx2tLRItH4cjFVaw==", null, false, "ZVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "veerle@cc.be", "8530" },
                    { "00000000-0000-0000-0000-000000000005", 0, "Waregem", "d8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "paulien@cc.be", true, "Paulien", "Desmet", false, null, "PAULIEN@CC.BE", "PAULIEN@CC.BE", "AQAAAAEAACcQAAAAEEmbHws8bH2hsqCu/sQNPrKWT7/k4q7+AXgOvY5d3avF3ScBsafcpasYwY894ZjHfQ==", null, false, "XVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "paulien@cc.be", "8790" },
                    { "00000000-0000-0000-0000-000000000006", 0, "Waregem", "k8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "f.v@telenet.be", true, "Filip", "Verhelst", false, null, "F.V@TELENET.BE", "F.V@TELENET.BE", "AQAAAAEAACcQAAAAEJ5saySg477E8kjawuiflIlbk/sttOlATAid9pc/awcGeN44G4FzyZsrzD19qqkgUg==", null, false, "BVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "f.v@telenet.be", "8790" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Index", "", "Home", "Films", 1 },
                    { 2, "LogIn", "", "User", "Aanmelden", 2 },
                    { 3, "Register", "", "User", "Aanmaken", 3 },
                    { 4, "Privacy", "", "Home", "Bescherming", 4 },
                    { 5, "Index", "Admin", "Movies", "Films", 1 },
                    { 6, "IndexActors", "Admin", "Admin", "Acteurs", 2 },
                    { 7, "IndexDirectors", "Admin", "Admin", "Regisseurs", 3 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "CompanyId", "Description", "EventDate", "Imagestring", "LocationId", "Price", "SuccesRate", "Title" },
                values: new object[,]
                {
                    { 1, 2, "Twintig jaar na een spraakmakende affaire bereiden Gracie en haar man Joe zich voor op het afstudeerfeest van hun tweeling. Maar dan komt Hollywood-actrice Elizabeth Berry langs om zich voor te bereiden op haar rol als Gracie in een nieuwe film. Terwijl ze elkaar bestuderen, ontdekken ze dat ze meer overeenkomsten hebben dan ze hadden verwacht.", new DateTime(2024, 3, 25, 20, 0, 0, 0, DateTimeKind.Unspecified), "may-december.jpg", 3, 9.0, 65, "May December" },
                    { 2, 1, "Ferrari wordt geprezen als een succesverhaal, dankzij hun talloze triomfen in de Formule 1, met iconen zoals Niki Lauda en Michael Schumacher. Oorspronkelijk opgericht in 1929 als raceteam, heeft het Italiaanse automerk echter een hobbelige ontstaansgeschiedenis gekend. In 1957 verkeerde het bedrijf in ernstige financiële problemen, en Ferrari blikt terug op deze uitdagende periode.\r\nDe uitnodigende subtitel van Brock Yates' biografische boek, waar de film op is gebaseerd, leest: 'De man, de auto's, de races en de machine.'", new DateTime(2024, 4, 13, 20, 0, 0, 0, DateTimeKind.Unspecified), "ferrari.jpg", 3, 9.0, 70, "Ferrari" },
                    { 3, 1, "Zanger, muzikant en conservator van het ontroerend muzikaal erfgoed Jan De Smet werd zeventig. In 2024 viert hij die verjaardag met ons in de Schouwburg en het is een Grote Luxe (vandaar de titel!) om hem te mogen ontvangen met een schare uitgelezen muzikanten en zangeressen die een zeer eclectisch muzikaal programma beheersen.", new DateTime(2024, 4, 20, 20, 0, 0, 0, DateTimeKind.Unspecified), "jan_de_wilde_de_grote_luxe.jpg", 1, 23.0, 90, "Jan De Smet en de Grote Luxe" },
                    { 4, 2, "Alex Agnew geeft in zijn negende comedyshow de post-pandemie-wereld een pandoering", new DateTime(2024, 4, 24, 20, 0, 0, 0, DateTimeKind.Unspecified), "AA_wake_me_up.jpg", 1, 31.0, 99, "Wake Me Up When It’s Over" },
                    { 5, 2, "Na hun succesvolle voorstellingen Mining Stories en Pleasant Island maken Silke Huysmans en Hannes Dereere het sluitstuk van hun trilogie over mijnbouw. Deze keer gaan ze dieper in op een compleet nieuwe industrie: diepzeemijnbouw.", new DateTime(2024, 4, 24, 20, 0, 0, 0, DateTimeKind.Unspecified), "sile_huysmans_out-of-the-blue.jpg", 2, 17.0, 40, "Out of the Blue " },
                    { 6, 1, "Een actuele situatiekomedie met kleurrijke personages en hilarische toestanden. De Padelburen verzekert het publiek een avond onvervalste pret! Zoals men stilaan gewoon is van Het Prethuis!", new DateTime(2024, 5, 28, 20, 0, 0, 0, DateTimeKind.Unspecified), "prethuis_de_padelburen.jpg", 1, 22.0, 80, "Het prethuis" },
                    { 7, 3, "Met festivals gepland in Frankrijk, Spanje, Nederland en Bulgarije, wil Selah Sue helemaal klaar zijn voor haar tour. Dus besluit ze met haar band een tijdje in onze clubzaal te bivakkeren. Tot onze grote vreugde sluit ze die repetitieperiode af met een exclusief try-out concert.", new DateTime(2024, 5, 16, 20, 0, 0, 0, DateTimeKind.Unspecified), "selah_sue.jpg", 2, 35.0, 100, "Selah Sue (try-out)" },
                    { 8, 4, "De kunstacademie brengt dansen uitgevoerd door de eigen leerlingen.", new DateTime(2024, 5, 25, 20, 0, 0, 0, DateTimeKind.Unspecified), null, 1, 5.0, 75, "Dance 2024" },
                    { 9, 5, "Samen met een professioneel theatermaker van LARF! breng je je wildste toekomstfantasieën tot leven. Je kruipt in de huid van futuristische helden, intergalactische ontdekkingsreizigers en revolutionaire uitvinders. Je onderzoekt wat theater is en ontdekt hoe je zelf speelt en beweegt. Zo ga je op zoek naar je eigen personage met een eigen geluid, hoe luid of stil dat ook is.", new DateTime(2024, 7, 8, 9, 0, 0, 0, DateTimeKind.Unspecified), "Het theater van de toekomst.jpg", 2, 150.0, 100, "Het theater van de toekomst. Een schakelkamp voor het 4e, 5e en 6e leerjaar" }
                });
