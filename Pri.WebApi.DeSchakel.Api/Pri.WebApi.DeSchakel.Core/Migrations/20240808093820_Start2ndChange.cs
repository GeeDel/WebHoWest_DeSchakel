...
{
    public partial class Start2ndChange : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-0000-0000-0000-000000000001", "f68bc41c-1905-42a4-bf15-49c2a1cf70fd", "Admin", "ADMIN" },
                    { "00000000-0000-0000-0000-000000000002", "fe3fcb23-4159-444d-816f-3c644c4e1f24", "Programmator", "PROGRAMMATOR" },
                    { "00000000-0000-0000-0000-000000000003", "6346d62a-c6e9-4742-8746-50e7df638fb1", "Onthaal", "ONTHAAL" },
                    { "00000000-0000-0000-0000-000000000004", "70bb34e2-1aa0-4a56-9998-a7459cea399a", "Bezoeker", "BEZOEKER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-0000-0000-0000-000000000001", 0, "Beveren-Leie", "c8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@cc.be", true, "Geert", "Deloof", false, null, "ADMIN@CC.BE", "ADMIN@CC.BE", "AQAAAAEAACcQAAAAEAsae1IyM2/MtvnkvVQCeBvIw9XvAPUdcw4QaRwCgZ5+igKtoh2GYhAhhinUMA+L/Q==", null, false, "VVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "admin@cc.be", "8791" },
                    { "00000000-0000-0000-0000-000000000002", 0, "Gent", "d8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "maaike@cc.be", true, "Maaike", "Tubex", false, null, "MAAIKE@CC.BE", "MAAIKE@CC.BE", "AQAAAAEAACcQAAAAEIthZ144ZUjEm5GGOYxLnFjwsPp6MriEmey9f7LYZa6T5j61Bqt+Huq/Mg35dVpnZA==", null, false, "XVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "maaike@cc.be", "9000" },
                    { "00000000-0000-0000-0000-000000000003", 0, "Waregem", "e8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "joost@cc.be", true, "Joost", "Van den Kerkhove", false, null, "JOOST@CC.BE", "JOOST@CC.BE", "AQAAAAEAACcQAAAAEPKDUjtKU6h/if9X3EK+zIaxyKtDS4k2aWmgoKE5dxPYH+UqsO78ODqdcKNkcqM0WQ==", null, false, "ZVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "joost@cc.be", "8790" },
                    { "00000000-0000-0000-0000-000000000004", 0, "Harelbeke", "e8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "veerle@cc.be", true, "Veerle", "Hollants", false, null, "VEERLE@CC.BE", "VEERLE@CC.BE", "AQAAAAEAACcQAAAAEEUFZLpaRDImHqEJnbfa7IpkrsqzJtyo9PwpnzNOZwW/qL1awxqSCAQD/ZzeqnueAQ==", null, false, "ZVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "veerle@cc.be", "8530" },
                    { "00000000-0000-0000-0000-000000000005", 0, "Waregem", "d8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "paulien@cc.be", true, "Paulien", "Desmet", false, null, "PAULIEN@CC.BE", "PAULIEN@CC.BE", "AQAAAAEAACcQAAAAEMQLv4UmuRfHLV1Ai4ZnKVmPfiF48jSrywDJ7JnTCaxzCxq2Z9asEw5QiI1FS4jP+w==", null, false, "XVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "paulien@cc.be", "8790" },
                    { "00000000-0000-0000-0000-000000000006", 0, "Waregem", "k8554266-b401-4519-9aeb-a9283053fc58", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "f.v@telenet.be", true, "Filip", "Verhelst", false, null, "F.V@TELENET.BE", "F.V@TELENET.BE", "AQAAAAEAACcQAAAAEO2Ar8EUCjRUpNYJF4JN2FfxWI83mnI/Z/qc2PIO++O6r9D3PasW+GoU2rkwGfSYmA==", null, false, "BVPCRDAS3MJWQD5CSW2GWPRADBXEZINA", false, "f.v@telenet.be", "8790" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Companies", "Staff", "Staff", "Gezelschappen", 2 },
                    { 4, "Locations", "Staff", "Staff", "Locaties", 3 },
                    { 5, "Genres", "Staff", "Staff", "Genres", 4 },
                    { 6, "NewAbo", "Home", "Home", "Nieuw", 2 },
                    { 7, "Voucher", "Home", "Home", "Waregembon", 3 }
                });
